...
func TestValidateManifestRejectsLegacyNamespace(t *testing.T) {
	manifest := Manifest{}
	manifest.APIVersion = "legacy.plugin/v2"
	manifest.Metadata.ID = "legacy"
	manifest.Metadata.Name = "Legacy"
