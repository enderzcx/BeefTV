...
export type CreationStatus = "idle" | "running" | "waiting_answer" | "waiting_proposal" | "waiting_canvas" | "waiting_execution" | "waiting_task" | "paused" | "completed" | "cancelled";
...
export type CreationSubmission = {
    ...
    execution: { model: string; configHash: string; options?: Record<string, unknown> };
