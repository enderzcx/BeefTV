...
export const CANVAS_SHORTCUTS: CanvasShortcutItem[] = [
    ...
    },
    {
        ...
        category: "navigation",
        title: "整理画布",
        description: "按节点类型和连接关系自动整理画布布局",
        keys: [["Option", "Shift", "F"]],
        keywords: ["排列", "整理", "自动布局", "arrange"],
    },
    {
        id: "pan",
        category: "navigation",
    ...
    },
    {
        ...
        category: "navigation",
        title: "快速调整视图",
        description: "0/2 适应画布，1 恢复 100%，3 适应选择",
    ...
    },
    {
        ...
        category: "selection",
        title: "切换移动工具",
        description: "按 V 或从底部工具菜单切换到移动工具，在空白处拖动可框选节点",
        keys: [["V"]],
    ...
    },
    {
        ...
        category: "navigation",
        title: "切换抓手工具",
        description: "按 H 或从底部工具菜单切换到抓手工具，拖动平移画布",
        keys: [["H"]],
        keywords: ["工具栏", "平移", "hand"],
    },
    {
        id: "add-selection",
        category: "selection",
