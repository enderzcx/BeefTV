...
export type CreativePendingInteraction = CreativeQuestionRequest | (CreativeInteractionIdentity & { kind: "proposal_request"; proposalId: string; proposalVersion: number });
...
const reservedCreativeFields = new Set([
    ...
    "autorun", "status", "runid", "taskid", "submissionid", "revision", "lease", "ownerepoch",
    "proposalapproved", "approvedproposalversion", "executionapproved", "executed",
]);

/** Brief fields hold requirements only; they never grant tool, proposal or execution approval. */
