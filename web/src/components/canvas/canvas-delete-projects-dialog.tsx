...
export function CanvasDeleteProjectsDialog() {
    ...
    const deletionLabel = isLocalWorkspaceMode() ? "本地画布" : "画布";
    const confirm = async () => {
        setDeleting(true);
        try {
            await deleteWorkspaceCanvasProjects(ids);
            // Local deletion records its recovery snapshot inside the local repository.
            void cleanupImages();
